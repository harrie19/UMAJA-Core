...
class PassiveDiscoveryAgent:
    ...
    def create_structured_metadata(self) -> Dict[str, Any]:
        ...
        metadata = {
            "schema_org": {
                ...
                "name": "UMAJA-Core",
                "description": "Bahá'í-inspired AI system for bringing smiles to all 8 billion people",
                ...
                "keywords": "AI ethics, hallucination mitigation, Bahá'í principles, vector embeddings",
                "license": "https://opensource.org/licenses/MIT",
                "codeRepository": "https://github.com/harrie19/UMAJA-Core"
            },
            "open_graph": {
                "og:title": "UMAJA-Core: AI Truth Framework",
                "og:description": "Bahá'í-inspired AI bringing smiles to 8 billion people",
                "og:type": "website",
    ...
    def generate_full_registry(self) -> Dict[str, Any]:
        ...
        registry = {
            ...
            "principles": {
                "truth_over_optimization": "Reality over fantasy. Honest numbers over hype.",
                "service_not_profit": "Success = lives touched, not dollars earned.",
                "unity_of_humanity": "No division by race, religion, nationality, class.",
                "open_source_free": "All code public. All content free. All channels simultaneous."
            },
            "contact": {
