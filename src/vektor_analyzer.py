...
class VektorAnalyzer:
    ...
    def analyze_coherence(self, text: str, theme: str) -> Dict[str, any]:
        """
        Analyze the coherence of a text in relation to a theme.
        ...
        Returns:
            ...
            - theme_similarity: Similarity score to theme (0-1)
        ...
        theme_similarity = float(self.cosine_similarity(theme_embedding, text_embedding))
        ...
        return {
            ...
            'avg_inter_sentence_coherence': avg_inter_sentence_coherence,
